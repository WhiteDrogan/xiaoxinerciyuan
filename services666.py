...
def getStationFlow2():
    db = pymysql.connect(host='localhost', user='root', password='root',
                            database='subway', port=3306, charset='utf8')
    cursor = db.cursor()
    cursor.execute("select count(*) from trips where entername='Sta18' GROUP BY entername")
    data5 = cursor.fetchall()
    cursor.execute("select count(*) from trips where exitname='Sta18' GROUP BY exitname")
    data6 = cursor.fetchall()
    db.commit()
    db.close
    return [data5, data6]
...
def getStationFlow3():
    db = pymysql.connect(host='localhost', user='root', password='root',
                            database='subway', port=3306, charset='utf8')
    cursor = db.cursor()
    cursor.execute("select count(*) from trips where entername='Sta1' GROUP BY entername")
    data5 = cursor.fetchall()
    cursor.execute("select count(*) from trips where exitname='Sta1' GROUP BY exitname")
    data6 = cursor.fetchall()
    db.commit()
    db.close
    return [data5, data6]
...
def getStationCount2():
    db = pymysql.connect(host='localhost', user='root', password='root',
                            database='subway', port=3306, charset='utf8')
    cursor = db.cursor()
    cursor.execute("select sum(Sta18) from everyday where exactdate='2020-07-16'")
    data7 = cursor.fetchall()
    cursor.execute("select sum(Sta18) from everyday where exactdate<='2020-07-16' and exactdate>='2020-07-13'")
    data8 = cursor.fetchall()
    cursor.execute("select sum(Sta18) from everyday where exactdate<='2020-07-16' and exactdate>='2020-07-01'")
    data9 = cursor.fetchall()
    db.commit()
    db.close
    return [data7, data8, data9]
...
def getStationCount3():
    db = pymysql.connect(host='localhost', user='root', password='root',
                            database='subway', port=3306, charset='utf8')
    cursor = db.cursor()
    cursor.execute("select sum(Sta1) from everyday where exactdate='2020-07-16'")
    data7 = cursor.fetchall()
    cursor.execute("select sum(Sta1) from everyday where exactdate<='2020-07-16' and exactdate>='2020-07-13'")
    data8 = cursor.fetchall()
    cursor.execute("select sum(Sta1) from everyday where exactdate<='2020-07-16' and exactdate>='2020-07-01'")
    data9 = cursor.fetchall()
    db.commit()
    db.close
    return [data7, data8, data9]
...
def getStationPrediction2():
    db = pymysql.connect(host='localhost', user='root', password='root',
                            database='subway', port=3306, charset='utf8')
    cursor = db.cursor()
    cursor.execute("select July17,July18,July19,July20,July21,July22,July23,July24,July25,July26,July27,July28,July29,July30,July31 from prediction where list=18")
    data = cursor.fetchall()
    db.commit()
    db.close
    return data

def getStationPrediction3():
    db = pymysql.connect(host='localhost', user='root', password='root',
                            database='subway', port=3306, charset='utf8')
    cursor = db.cursor()
    cursor.execute("select July17,July18,July19,July20,July21,July22,July23,July24,July25,July26,July27,July28,July29,July30,July31 from prediction where list=1")
    data = cursor.fetchall()
    db.commit()
    db.close
    return data